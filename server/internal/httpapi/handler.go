...
func NewHandler(deps Deps) http.Handler {
	...
	mux.Handle("GET /api/tweets/{id}", requireUser(handleGetThread(deps, tweetSvc)))
	mux.Handle("DELETE /api/tweets/{id}", requireUser(handleDeleteTweet(deps, tweetSvc)))
	mux.Handle("POST /api/tweets/{id}/replies", requireUser(handleCreateReply(deps, tweetSvc)))
